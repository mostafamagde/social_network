...
class NetworkAnalysisGUI:
    ...
    def create_main_frames(self):
        ...
        # Left panel - Controls
        self.control_frame = ttk.Frame(self.master, width=300, style='Primary.TFrame')
        self.control_frame.pack(side=tk.LEFT, fill=tk.Y, padx=5, pady=5)
        
        # Right panel - Output
        self.output_frame = ttk.Frame(self.master, style='Secondary.TFrame')
        self.output_frame.pack(side=tk.RIGHT, fill=tk.BOTH, expand=True, padx=5, pady=5)
        
        # Center panel - Visualization
        self.visualization_frame = ttk.Frame(self.master)
        self.visualization_frame.pack(side=tk.TOP, fill=tk.BOTH, expand=True, padx=5, pady=5)
    ...
    def create_control_widgets(self):
        ...
        load_frame = ttk.LabelFrame(self.control_frame, text="Data Loading", style='Header.TLabel')
        ...
        graph_frame = ttk.LabelFrame(self.control_frame, text="Graph Type", style='Header.TLabel')
        ...
        vis_frame = ttk.LabelFrame(self.control_frame, text="Visualization Settings", style='Header.TLabel')
        ...
        comm_frame = ttk.LabelFrame(self.control_frame, text="Community Detection", style='Header.TLabel')
        ...
        # Centrality Filters
        filter_frame = ttk.LabelFrame(self.control_frame, text="Centrality Filters", style='Header.TLabel')
        ...
        # Metrics Section
        metrics_frame = ttk.LabelFrame(self.control_frame, text="Metrics", style='Header.TLabel')
        ...
        # Clear Button
        ttk.Button(self.control_frame, text="Clear All", style='Danger.TButton',
    ...
    def filter_centrality(self, centrality_type):
        ...
        try:
            ...
            for node in sorted(filtered_nodes, key=lambda x: centrality[x], reverse=True):
                self.output_text.insert(tk.END, f"Node {node}: {centrality_type} = {centrality[node]:.4f}\n")
            
            self.log_message(f"Filtered by {centrality_type} centrality (threshold={threshold})")
